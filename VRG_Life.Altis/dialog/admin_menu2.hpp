class life_admin_menu {
	...
	class controls {
		...
		class ScrollMenu : Life_RscButtonMenu {
			idc = 2912;
			text = "$STR_Admin_Scroll_Menu";
			onButtonClick = "[] call life_fnc_adminScrollMenu;";
			x = 0.06 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.885 + (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
		...
		class Admining : Life_RscButtonMenu {
			idc = 2916;
			text = "$STR_Admin_Admining";
			onButtonClick = "[] call life_fnc_admining;";
			x = -0.06 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.885 + (1 / 25);
			w = (6.25 / 40);
			h = (1 / 25);
