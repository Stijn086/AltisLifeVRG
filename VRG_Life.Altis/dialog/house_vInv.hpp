...
class RscText_1001: Life_RscText
{
	...
	text = "Virtual Home Inventory"; //--- ToDo: Localize;
	x = 0.276617 * safezoneW + safezoneX;
	y = 0.235933 * safezoneH + safezoneY;
	w = 0.446778 * safezoneW;
...
class RscText_1002: Life_RscText
{
	...
	text = "Home Inventory"; //--- ToDo: Localize;
...
class RscText_1015: Life_RscText
{
	...
	text = "CAUTION : Before removing a weapon or a backpack , make sure"; //--- ToDo: Localize;
...
class RscText_1016: Life_RscText
{
	...
	text = "you have no weapon or backpack attached to your current player if there."; //--- ToDo: Localize;
	x = 0.282233 * safezoneW + safezoneX;
...
class RscText_1017: Life_RscText
{
	...
	text = "Is weapons or a backpack on your player or in hand the system"; //--- ToDo: Localize;
	x = 0.282233 * safezoneW + safezoneX;
...
class RscText_1018: Life_RscText
{
	...
	text = "will overwrite them if you already have them on you"; //--- ToDo: Localize;
	x = 0.282233 * safezoneW + safezoneX;
