...
if(_value > 20000000) exitWith {hint localize "STR_ANOTF_Fail"};
...
if(_action) then {
        ...
        closeDialog 0;
        [[0,format["Admin %1 has comped a player $%2",profileName,_value]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
} else {
