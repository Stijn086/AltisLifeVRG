/*
	...
	Description:
	Saves the player / pmcs gear in a formatted array.
*/
...
pmc_gear = [_primary,_handgun,_magazines,_uniform,_vest,_backpack,_items,_primitems,_secitems,_handgunitems,_uitems,_vitems,_bitems];