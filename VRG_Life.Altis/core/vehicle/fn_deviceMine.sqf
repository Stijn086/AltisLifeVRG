...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","lead_1","iron_1","salt_1","sand_1","diamond_1","oil_1","oil_2","rock_1","blooddiamond_1","UraniumMine","silver_1"];
_zone = "";
...
_item = switch(true) do {
	...
	case (_zone in ["blooddiamond_1"]): {"blooddiamond"};
	case (_zone in ["UraniumMine"]): {"uranium"};
