...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "eporn": {_var = "license_civ_eporn"};
			case "rebMedic": {_var = "license_civ_rebMedic"};
			case "rebSniper": {_var = "license_civ_rebSniper"};
			case "rebExplosive": {_var = "license_civ_rebExplosive"};
			case "rebGrenade": {_var = "license_civ_rebGrenade"};
			case "rebGunner": {_var = "license_civ_rebGunner"};
			case "rebChemical": {_var = "license_civ_rebChemical"};
			case "bath": {_var = "license_civ_bath"};
			case "uraniumWeap": {_var = "license_civ_uraniumWeap"};
			case "uraniumMed": {_var = "license_civ_uraniumMed"};
			case "painkill": {_var = "license_civ_painkill"};
			case "silver": {_var = "license_civ_silver"};
			case "blooddiamond": {_var = "license_civ_blooddiamond"};
			case "snuff": {_var = "license_civ_snuff"};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_eporn": {_var = "eporn"};
			case "license_civ_lsd": {_var = "lsd"};
			case "license_civ_rebMedic": {_var = "rebMedic"};
			case "license_civ_rebSniper": {_var = "rebSniper"};
			case "license_civ_rebExplosive": {_var = "rebExplosive"};
			case "license_civ_rebGrenade": {_var = "rebGrenade"};
			case "license_civ_rebGunner": {_var = "rebGunner"};
			case "license_civ_bath": {_var = "bath"};
			case "license_civ_uraniumWeap": {_var = "uraniumWeap"};
			case "license_civ_uraniumMed": {_var = "uraniumMed"};
			case "license_civ_painkill": {_var = "painkill"};
			case "license_civ_silver": {_var = "silver"};
			case "license_civ_blooddiamond": {_var = "blooddiamond"};
			case "license_civ_snuff": {_var = "snuff"};
