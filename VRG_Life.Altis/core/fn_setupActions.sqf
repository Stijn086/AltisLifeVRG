...
switch (playerSide) do
{
	case civilian:
	{
		...
		!isNull cursorTarget && player distance cursorTarget < 3.5 && isPlayer cursorTarget && animationState cursorTarget == "Incapacitated" && !(cursorTarget getVariable["raped",FALSE]) ']];
		// Suicide Bomb
