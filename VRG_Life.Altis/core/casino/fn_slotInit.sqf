...
_cash ctrlSetText format ["Your cash: $%1", [life_cash] call life_fnc_formatMoney];
...
_jackpot ctrlSetText format ["Current Jackpot: $%1", [life_jackpot] call life_fnc_formatMoney];