...
if (_respondmode==2) then {
	...
	player addEventHandler ["Hit", {
		...
		hintSilent parseText format ["<t align='center' color='#00E500' size='1.3'>Statistics</t><br/><br/><t align='left'>Deaths</t><t align='right'>%1</t><br/><t align='left'>Points</t><t align='right'>%2</t>",tode,_punkte];
	}];
};
...
if (_respondmode==3) then {
	...
	if (tode>=_grenzeAusz) then {
		...
		hint format ["The game has ended. You've earned a total of 1% points and receive a cash prize ($%2) Congratulations!!",_punkte,_gesamt];
	};
};
